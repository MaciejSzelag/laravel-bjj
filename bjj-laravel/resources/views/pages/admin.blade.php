    ...
    <div class="wrap-log">
        ...
        <form action="pages/admin/dashboard" method="POST">
            ...
            <div class="container">
                ...
                <input type="text" placeholder="Enter Username" name="uname" value="Ian Harrop"required>

                <label for="psw"><b>Password</b></label>
                <input type="password" placeholder="Enter Password" name="password" value="Ian Harrop" required>
